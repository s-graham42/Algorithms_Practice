...
def find_2_movies(flight_length, movie_lengths):
    movies_seen = set()
    for movie in movie_lengths:
        if flight_length - movie in movies_seen:
            print(flight_length - movie, movie)
            return True
        else:
...
movies = [12, 4, 18, 11, 19, 14, 6, 9, 19, 11, 9, 10]

print(find_2_movies(39, movies))